...
export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-6 dark:bg-gray-950 sm:px-6 sm:py-8">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-[460px] flex-col justify-center">
        <Link
          to="/"
          className="relative -mb-4 flex items-center justify-center leading-none sm:-mb-2"
        >
          <img
            src="/images/logo/logo.png"
            alt="Expenzoir"
            className="block h-36 w-auto max-w-[92vw] object-contain sm:h-32"
          />
        </Link>
